...
import { u as k, r as G, a as J, b as H, c as A, d as j, e as X, f as E, g as Y, h as Z, i as R, j as K, k as ee, m as te, G as ne, n as se, o as ae, p as F, q as re, t as ce, v as _, w as x, x as W, y as oe, l as w, z as ie, A as ue, B as N, C as de, D as le, E as fe, F as pe, H as be, I as me, J as ge, K as Se, M as B, N as ve, O as he, P as Me, Q as ye, S as Pe, T as ke, U as Ee, V as Te, W as Q, X as we, Y as Ae, Z as Ce, _ as Oe, $ as Ie, a0 as De, a1 as Le, a2 as Re, a3 as Fe, a4 as Ne, a5 as Ve, a6 as Be, a7 as L, a8 as ze, a9 as Ue } from "./contexts-BIrOxv6y.mjs";
import { m as T } from "./room-DI7DLgYS.mjs";
import { ConnectionQuality as qe, ConnectionState as C, LocalTrackPublication as Je, facingModeFromLocalTrack as _e, Room as xe, Track as y, createAudioAnalyser as V, ParticipantKind as We } from "livekit-client";
const Qe = (e) => {
  const n = r.useRef(e);
  return r.useEffect(() => {
    n.current = e;
...
function Mt(e = {}) {
  const n = A(e.participant), { className: t, connectionQualityObserver: a } = r.useMemo(
    () => j(n),
    [n]
  ), s = b(a, qe.Unknown);
...
function yt(e, n) {
  const t = typeof e == "function" ? e : n, a = typeof e == "string" ? e : void 0, s = E(), { send: c, messageObservable: o, isSendingObservable: u } = r.useMemo(
    () => Y(s, a, t),
    [s, a, t]
...
function Pt(e) {
  const n = E(), t = O(n);
  return { buttonProps: r.useMemo(() => {
    const { className: s, disconnect: c } = Z(n);
    return T(e, {
      className: s,
      onClick: () => c(e.stopTracks ?? !0),
      disabled: t === C.Disconnected
    });
  }, [n, e, t]) };
}
function Xe(e) {
  if (e.publication instanceof Je) {
    const n = e.publication.track;
    if (n) {
      const { facingMode: t } = _e(n);
      return t;
    }
  }
  return "undefined";
...
function kt({ trackRef: e, props: n }) {
  const t = R(e), a = K(), { className: s } = r.useMemo(() => ee(), []), c = r.useMemo(() => te(t, a == null ? void 0 : a.pin.state), [t, a == null ? void 0 : a.pin.state]);
...
function z(e, n = {}) {
  var u, i;
  const t = typeof e == "string" ? n.participant : e.participant, a = A(t), s = typeof e == "string" ? { participant: a, source: e } : e, [c, o] = r.useState(
...
function Ye(e) {
  const n = A(e), t = r.useMemo(() => re(n), [n]);
...
function wt({
  ...
  const c = x(), o = r.useMemo(() => n ?? c ?? new xe(), [n, c]), u = r.useMemo(
    () => W(e, s, a),
    [e, a, s]
  ...
  return r.useEffect(() => {
    const S = p.subscribe((m) => {
      m && (w.info("setCurrentDeviceId", m), l(m));
    });
    return () => {
...
function It(e = {}) {
  const n = A(e.participant), t = r.useMemo(() => _(n), [n]);
...
function Dt({
  ...
  const s = R(e), c = r.useMemo(() => {
    ...
    publication: o
  }), [o, s.participant]), i = z(s), d = z(u), l = Ye(s.participant), f = Xe(s);
  return {
    elementProps: {
...
function Ft(e, n = {}) {
  const t = E(), [a] = r.useState(n.updateOnlyOn), s = r.useMemo(() => typeof e == "string" ? be(t, e, {
    additionalEvents: a
  }) : me(t, e, {
    additionalEvents: a
...
function xt({
  ...
  var P;
  const u = x(), i = (P = u == null ? void 0 : u.localParticipant) == null ? void 0 : P.getTrackPublication(e), d = r.useRef(!1), { toggle: l, className: f, pendingObserver: p, enabledObserver: g } = r.useMemo(
    () => u ? Pe(e, u, a, s, c) : ke(),
  ...
  r.useEffect(() => {
    ...
    t !== void 0 && (w.debug("forcing initial toggle state", e, t), l(t));
  }, []);
  const M = r.useMemo(() => T(o, { className: f }), [o, f]), v = r.useCallback(
    (h) => {
      var I;
...
function Wt(e = [
  ...
  return r.useEffect(() => {
    const d = Te(t, u, {
      ...
      w.debug("setting track bundles", l, f), s(l), o(f);
    });
    return () => d.unsubscribe();
  }, [
    t,
...
function Qt(e, n) {
  const t = A(n);
  return st({ name: e, participant: t });
}
function $t(e) {
  const n = E(), t = O(n), a = r.useMemo(
    () => t === C.Disconnected,
    [t]
  ), s = r.useMemo(
    () => Ce(n, e),
...
function Ht(e, n = {}) {
  const t = A(e), a = k(n.room), s = r.useMemo(() => De(a, t), [a, t]);
  return b(
    s,
...
function Xt(e, n = {}) {
  var o;
  const t = e instanceof y ? e : (o = e == null ? void 0 : e.publication) == null ? void 0 : o.track, a = { ...rt, ...n }, [s, c] = r.useState(
...
function Yt(e, n = {}) {
  var l;
  const t = e instanceof y ? e : (l = e == null ? void 0 : e.publication) == null ? void 0 : l.track, a = { ...ct, ...n }, s = r.useRef(new Float32Array()), c = r.useRef(performance.now()), o = r.useRef(0), [u, i] = r.useState([]), d = r.useCallback((f) => {
    i(
      Array.from(
        it(f, a.barCount).map((p) => Math.sqrt(p) * a.volMultiplier)
...
function ut(e, n) {
  const t = E(), a = N(), s = n ? t.getParticipantByIdentity(n) : a, c = r.useMemo(
...
function ft(e, n) {
  const t = { ...lt, ...n }, [a, s] = r.useState([]), c = dt(e), o = (u) => {
    var i;
...
function Zt(e, n = {}) {
  const t = A(n.participant), [a, s] = r.useState(t.attributes[e]);
  return r.useEffect(() => {
    if (!t)
      return;
...
function Kt() {
  const e = $().find((o) => o.kind === We.AGENT), n = ut([y.Source.Microphone], e == null ? void 0 : e.identity)[0], { segments: t } = ft(n), a = O(), { attributes: s } = pt({ participant: e }), c = r.useMemo(() => a === C.Disconnected ? "disconnected" : a === C.Connecting || !e || !(s != null && s[q]) ? "connecting" : s[q], [s, e, a]);
  return {
    agent: e,
    state: c,
    audioTrack: n,
...
function tn(e) {
  const n = E(), t = O(n), a = r.useMemo(
    () => t === C.Disconnected,
    [t]
  ), s = r.useMemo(() => Ue(n, e), [n, e, a]);
  return { textStreams: b(s, []) };
}
export {
  Tt as A,
  Rt as B,
...
//# sourceMappingURL=hooks-D-XcLLlf.mjs.map
